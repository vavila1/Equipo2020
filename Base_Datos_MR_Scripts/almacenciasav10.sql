...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2020 at 08:37 PM
...
UPDATE producto SET cantidad = 0 wHERE id = id_producto;
COMMIT;
END$$
...
(26, 'Frutsi', 25, 6, 4, 2, 1, 6),
(27, 'FrutsiED', 1, 150, 3, 1, 1, 1),
(28, 'Cemento Refractario Humedo Cubeta', 0, 12, 1, 1, 1, 3);
...
--
-- AUTO_INCREMENT for table `entregan`
--
ALTER TABLE `entregan`
