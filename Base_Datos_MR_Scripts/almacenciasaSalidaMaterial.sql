...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-05-2020 a las 22:39:03
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `registrarSalidaHerramienta` (IN `id_producto` INT(10), IN `id_proyecto` INT(10), IN `id_empleado` INT(10), IN `cantidad` INT(10))  NO SQL
BEGIN
START TRANSACTION;

INSERT INTO producto_proyecto  (Id_Producto, Id_Proyecto, Cantidad_Asignada) VALUES (id_producto, id_proyecto,cantidad);
...
(0, 2, 'Proyecto Almecenes xd', '2020-05-16 19:01:02', NULL),
